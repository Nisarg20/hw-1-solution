...
public class TestPairWise3 {
    ...
    public void test3() {
        Set<Integer> s1 = null;
        Set<Integer> s2 = new HashSet<>(Arrays.asList(1,2));
        Set<Integer> expected = new HashSet<>();
        assertEquals(expected, Sets.intersection(s1, s2));
    }
    ...
    @Test
    public void test6() {
        Set<Integer> s1 = new HashSet<>(Arrays.asList(4,5,6));
    ...
    @Test
    public void test7() {
        Set<Integer> s1 = new HashSet<>(Arrays.asList(4,5,6,7,8));
    ...
    public void test8() {
        Set<Integer> s1 = new HashSet<>(Arrays.asList(4,5,6));
        Set<Integer> s2 = new HashSet<>(Arrays.asList(6,7,8));
        Set<Integer> expected = new HashSet<>();
        expected.add(6);
        assertEquals(expected, Sets.intersection(s1, s2));
    }
